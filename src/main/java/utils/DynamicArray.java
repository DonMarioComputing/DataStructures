...
//    }
//
//    public String set(String element, int position) {
//
//        if (position < 0 || position >= size) {
//            throw new IndexOutOfBoundsException("Invalid index: " + position);
//        }
...
//        }
//
//        String removedElement = data[position];
//
...
//    }
    ...
    // to do: add() - shift insert
    // to do: resize()/grow()
    // to do: remove() - shift delete
    // to do: get() - like overwrite, but return instead of replace
    // to do: contains()
//}
package utils;
